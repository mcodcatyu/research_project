...
cm_threshold = 0.8 # confusion metrix plot threshold
...
for idx, (name, base_clf) in enumerate(base_models.items()):
    ...
    # use 10% as subset to do grid sesrch
    ...
    # set different threshold to see the results
    ...
    # confusion metrix only plot the threshold = 0.8
    ...
    #*********************************************************************************************
    #============= PU Learning Framework (use the best param searched above) =====================
    #**********************************************************************************************
