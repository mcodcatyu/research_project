...
for start_year in years:
    ...
    # data_test = data_test.set_index('datetime').sort_index()
        ...
        grid = GridSearchCV(estimator=pipe_rnd, param_grid = param_grid,  scoring='average_precision', n_jobs=1, return_train_score=True)
    ...
    #====== 
        ...
        import gc
        del data_train, data_test, X_train, X_test, X_train_final, X_test_final
        gc.collect()
