...
class GCMDprocessor:
    ...
    def _retrain(self, df, MODEL_DIR):
        target = 'label_c_nan'
        #建立isc_nan label
        ...
        feature_cols= [
            ...
            'last_std_ht',
            'last_air_ht', 'last_std_area', 'last_air_area', 'last_std_rt', 'last_air_rt', 'last_std_start_level',
        ...
        return X_train_final, model, model_filename
